...
.LFB2:
	...
	movaps	%xmm7, 192(%rsp)
.L18:
	.stabn	68,0,64,.LM42-.LFBB3
.LM42:
	movq	%fs:40, %rax
	movq	%rax, 24(%rsp)
	xorl	%eax, %eax
	.stabn	68,0,67,.LM43-.LFBB3
.LM43:
	cmpq	$0, panicstr(%rip)
	je	.L23
	.p2align 4,,10
...
.LM50:
	leaq	.LC4(%rip), %rdi
	.stabn	68,0,74,.LM51-.LFBB3
.LM51:
	movq	%rax, 16(%rsp)
	.stabn	68,0,75,.LM52-.LFBB3
.LM52:
	xorl	%eax, %eax
	.stabn	68,0,74,.LM53-.LFBB3
.LM53:
	movl	$48, 4(%rsp)
	.stabn	68,0,75,.LM54-.LFBB3
.LM54:
	call	cprintf@PLT
	.stabn	68,0,76,.LM55-.LFBB3
.LM55:
	movq	%rbp, %rdi
	movq	%rsp, %rsi
	call	vcprintf@PLT
	.stabn	68,0,77,.LM56-.LFBB3
.LM56:
	leaq	.LC5(%rip), %rdi
	xorl	%eax, %eax
	call	cprintf@PLT
...
.LM62:
	leaq	.LC6(%rip), %rdi
	.stabn	68,0,92,.LM63-.LFBB4
.LM63:
	movq	%rax, 16(%rsp)
	.stabn	68,0,93,.LM64-.LFBB4
.LM64:
	xorl	%eax, %eax
	.stabn	68,0,92,.LM65-.LFBB4
.LM65:
	movl	$24, (%rsp)
	movl	$48, 4(%rsp)
	.stabn	68,0,93,.LM66-.LFBB4
.LM66:
	call	cprintf@PLT
	.stabn	68,0,94,.LM67-.LFBB4
.LM67:
	movq	%rbp, %rdi
	movq	%rsp, %rsi
	call	vcprintf@PLT
	.stabn	68,0,95,.LM68-.LFBB4
.LM68:
	xorl	%eax, %eax
	leaq	.LC5(%rip), %rdi
	call	cprintf@PLT
	.stabn	68,0,97,.LM69-.LFBB4
.LM69:
	movq	24(%rsp), %rax
	subq	%fs:40, %rax
	jne	.L28
